...
const searchIndex = [
  ...
  // From download_page.html (assume adding id="download-[name]" to each card div for scrolling)
  {
    title: "แบบฟอร์มยื่นคำร้อง",
    description: "อยากส่งสาส์นถึงมหาลัยเหรอ? มาเลย!",
    page: "download_page.html",
  ...
  // From about_page.html (assume adding id="about-[section]" to each hero div for scrolling)
  {
    title: "วังชมพู",
  ...
  // From contact_page.html (no anchors, navigate to page)
  {
    title: "กองพัฒนานักศึกษา",
    description: "ติดต่อกองพัฒนานักศึกษา",
    page: "contact_page.html",
    anchor: ""
  },
  {
